...
uses
  Classes, SysUtils,
  DBUS, ctypes, BaseTypes, coreinterfaces, netsupport;
...
const
  ...
  Introspect_xml = ' <!DOCTYPE node PUBLIC "-//freedesktop//DTD D-BUS Object Introspection 1.0//EN" "http://www.freedesktop.org/standards/dbus/1.0/introspect.dtd">'
           ...
           +#10+' 		<method name="Introspect">"'
           +#10+' 			<arg name="data" direction="out" type="s"/>'
           +#10+' 		</method>'
           +#10+' 	</interface>'
           +#10+' 	<interface name="org.freedesktop.DBus.Properties">'
           +#10+' 		<method name="Get">"'
           +#10+' 			<arg name="interface" direction="in" type="s"/>'
           +#10+' 			<arg name="property" direction="in" type="s"/>'
           +#10+' 			<arg name="value" direction="out" type="v"/>'
           +#10+' 		</method>'
           +#10+' 		<method name="GetAll">'
           +#10+' 			<arg name="interface" direction="in" type="s"/>'
           +#10+' 			<arg name="properties" direction="out" type="a{sv}"/>'
           +#10+' 		</method>'
           +#10+' 	</interface>'
           +#10+' 	<interface name="org.mpris.MediaPlayer2">'
           +#10+' 		<method name="Raise"/>'
           +#10+' 		<method name="Quit"/>'
           +#10+' 		<property name="CanQuit" type="b" access="read"/>'
           +#10+' 		<property name="Fullscreen" type="b" access="readwrite"/>'
           +#10+' 		<property name="CanRaise" type="b" access="read"/>'
           +#10+' 		<property name="HasTrackList" type="b" access="read"/>'
           +#10+' 		<property name="Identity" type="s" access="read"/>'
           +#10+' 		<property name="DesktopEntry" type="s" access="read"/>'
           +#10+' 		<property name="SupportedUriSchemes" type="as" access="read"/>'
           +#10+' 		<property name="SupportedMimeTypes" type="as" access="read"/>'
           +#10+' 	</interface>'
           +#10+' 	<interface name="org.mpris.MediaPlayer2.Player">'
           +#10+' 		<method name="Next"/>'
           +#10+' 		<method name="Previous"/>'
           +#10+' 		<method name="Pause"/>'
           +#10+' 		<method name="PlayPause"/>'
           +#10+' 		<method name="Stop"/>'
           +#10+' 		<method name="Play"/>'
           +#10+' 		<method name="Seek">'
           +#10+' 			<arg direction="in" name="Offset" type="x"/>'
           +#10+' 		</method>'
           +#10+' 		<method name="SetPosition">'
           +#10+' 			<arg direction="in" name="TrackId" type="o"/>'
           +#10+' 			<arg direction="in" name="Position" type="x"/>'
           +#10+' 		</method>'
           +#10+' 		<method name="OpenUri">'
           +#10+' 			<arg direction="in" name="Uri" type="s"/>'
           +#10+' 		</method>'
           +#10+' 		<signal name="Seeked">'
           +#10+' 			<arg name="Position" type="x"/>'
           +#10+' 		</signal>'
           +#10+' 		<property name="PlaybackStatus" type="s" access="read"/>'
           +#10+' 		<property name="LoopStatus" type="s" access="readwrite"/>'
           +#10+' 		<property name="Rate" type="d" access="readwrite"/>'
           +#10+' 		<property name="Shuffle" type="b" access="readwrite"/>'
           +#10+' 		<property name="Metadata" type="a{sv}" access="read"/>'
           +#10+' 		<property name="Volume" type="d" access="readwrite"/>'
           +#10+' 		<property name="Position" type="x" access="read"/>'
           +#10+' 		<property name="MinimumRate" type="d" access="read"/>'
           +#10+' 		<property name="MaximumRate" type="d" access="read"/>'
           +#10+' 		<property name="CanGoNext" type="b" access="read"/>'
           +#10+' 		<property name="CanGoPrevious" type="b" access="read"/>'
           +#10+' 		<property name="CanPlay" type="b" access="read"/>'
           +#10+' 		<property name="CanPause" type="b" access="read"/>'
           +#10+' 		<property name="CanSeek" type="b" access="read"/>'
           +#10+' 		<property name="CanControl" type="b" access="read"/>'
           +#10+' 	</interface>'
           +#10+' 	<interface name="org.mpris.MediaPlayer2.TrackList">'
           +#10+' 		<method name="GetTracksMetadata">'
           +#10+' 			<arg direction="in" name="TrackIds" type="ao"/>'
           +#10+' 			<arg direction="out" name="Metadata" type="aa{sv}"/>'
           +#10+' 		</method>'
           +#10+' 		<method name="AddTrack">"'
           +#10+' 			<arg direction="in" name="Uri" type="s"/>'
           +#10+' 			<arg direction="in" name="AfterTrack" type="o"/>'
           +#10+' 			<arg direction="in" name="SetAsCurrent" type="b"/>'
           +#10+' 		</method>'
           +#10+' 		<method name="RemoveTrack">'
           +#10+' 			<arg direction="in" name="TrackId" type="o"/>'
           +#10+' 		</method>'
           +#10+' 		<method name="GoTo">'
           +#10+' 			<arg direction="in" name="TrackId" type="o"/>'
           +#10+' 		</method>'
           +#10+' 		<signal name="TrackListReplaced">'
           +#10+' 			<arg name="Tracks" type="ao"/>'
           +#10+' 			<arg name="CurrentTrack" type="o"/>'
           +#10+' 		</signal>'
           +#10+' 		<signal name="TrackAdded">'
           +#10+' 			<arg name="Metadata" type="a{sv}"/>'
           +#10+' 			<arg name="AfterTrack" type="o"/>'
           +#10+' 		</signal>'
           +#10+' 		<signal name="TrackRemoved">'
           +#10+' 			<arg name="TrackId" type="o"/>'
           +#10+' 		</signal>'
           +#10+' 		<signal name="TrackMetadataChanged">'
           +#10+' 			<arg name="TrackId" type="o"/>'
           +#10+' 			<arg name="Metadata" type="a{sv}"/>'
           +#10+' 		</signal>'
           +#10+' 		<property name="Tracks" type="ao" access="read"/>'
           +#10+' 		<property name="CanEditTracks" type="b" access="read"/>'
           +#10+' 	</interface>'
           +#10+' </node>';
  //jcf:format=on
...
(*                    dbus_message_iter_open_container(@sub1, DBUS_TYPE_DICT_ENTRY, nil, @sub2);
    ...
    end//            gm_log(verbose, G_LOG_LEVEL_DEBUG, 'Path matched %s', dbus_message_get_path(message_));
  ;
end;
